...
#include "../GIS_project/cmainwindow.h"
...
QT_MOC_LITERAL(3, 19, 11) // "slotClicked"

    },
    "Cmainwindow\0click\0\0slotClicked"
};
...
void Cmainwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cmainwindow::click)) {
                *result = 0;
                return;
            }
        }
