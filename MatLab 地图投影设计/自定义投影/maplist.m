...
i=i+1;
list(i).IdString       = 'quartic_sanson';
list(i).Classification = 'PseudocylindricalSanson';
list(i).Name           = 'Quartic Authalic';
list(i).ClassCode      = 'Pcyl';
...
% ----------------------------------------------------
i=i+1;
list(i).IdString       = 'equalpolycon';
list(i).Classification = 'PolyConic';
list(i).Name           = 'EqualPolyconic';
list(i).ClassCode      = 'Poly';
...
i=i+1;
list(i).IdString       = 'equalpolycon_zq';
list(i).Classification = 'PolyConic';
list(i).Name           = 'PolyconicZQ';
list(i).ClassCode      = 'Poly';
...
%----------------------------------------------
i=i+1;
list(i).IdString       = 'gnomonic_triat';
list(i).Classification = 'Azimuthal';
list(i).Name           = 'Gnomonic_T';
list(i).ClassCode      = 'Azim';

i=i+1;
list(i).IdString       = 'gnomonic_atlantic';
list(i).Classification = 'Azimuthal';
list(i).Name           = 'GnomonicA';
list(i).ClassCode      = 'Azim';
